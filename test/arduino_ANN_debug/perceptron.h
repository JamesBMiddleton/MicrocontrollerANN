...
public:
    ...
    StaticVec<float, MAX_NODES> backwards_pass(const StaticVec<float, MAX_NODES>& inputs, const StaticVec<float, MAX_NODES>& output_grads);
...
public:
    ...
    void init_weights();
    StaticVec<float, MAX_NODES> forward_pass(const StaticVec<float, MAX_NODES>& inputs);
    StaticVec<StaticVec<float, MAX_NODES>, MAX_NODES> backwards_pass(const StaticVec<float, MAX_NODES>& inputs,
                               const StaticVec<StaticVec<float, MAX_NODES>, MAX_NODES>& output_grad_matrix);
    const StaticVec<float, MAX_NODES>& get_outputs() const { return _prev_outputs; }
